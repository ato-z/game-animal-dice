 ...
 */
const randomName = () => {
    var em1 = bedeckEm[~~(bedeckEm.length * Math.random())]
    var em2 = nounEm[~~(nounEm.length * Math.random())]
    return em1 + '的' + em2
}
 ...
 * data 发送的信息
 * type 信息类型
 * error_code 不为0，则为失败信息
 */
const codeSendDataToJSONString = (data, type, error_code = 0, msg = 'ok') => {
    const codeData = {
        data, msg, type,
        error_code
    }
...
module.exports = {
    randomName, fillZero, codeSendDataToJSONString
}